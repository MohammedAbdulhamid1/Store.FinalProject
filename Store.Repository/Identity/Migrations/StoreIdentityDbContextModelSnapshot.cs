...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Core.Entites.Identity.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));
                    b.Property<string>("AppUserId").IsRequired().HasColumnType("text");
                    b.Property<string>("City").IsRequired().HasColumnType("text");
                    b.Property<string>("Country").IsRequired().HasColumnType("text");
                    b.Property<string>("FName").IsRequired().HasColumnType("text");
                    b.Property<string>("LName").IsRequired().HasColumnType("text");
            ...
            modelBuilder.Entity("Store.Core.Entites.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Store.Core.Entites.Identity.AppUser", null)
            ...
            modelBuilder.Entity("Store.Core.Entites.Identity.Address", b =>
                {
                    b.HasOne("Store.Core.Entites.Identity.AppUser", "AppUser")
                        .WithOne("Address")
                        .HasForeignKey("Store.Core.Entites.Identity.Address", "AppUserId")
